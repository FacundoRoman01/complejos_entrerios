...
>
  ...
  {/* Contenedor con espacio superior para que no lo tape el header */}
  <div 
    style={{ 
      position: 'relative', 
  ...
  >
    ...
    {/* <p style={{ fontFamily: "'Raleway',sans-serif", fontSize: 'clamp(24px,3vw,40px)', color: '#c3d19a', margin: '16px 0 0' }}>
...
>
  <div style={{ maxWidth: 1240, margin: '0 auto' }}>
    <div ref={espaciosHeading.ref} style={{ ...espaciosHeading.style, maxWidth: 760, margin: '0 auto clamp(40px,6vh,64px)', textAlign: 'center' }}>
      ...
      {/* Lista de características / íconos tal como en la foto */}
